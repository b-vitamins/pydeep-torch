...
class Test_AE_Model(unittest.TestCase):
    def test_init(self):
        sys.stdout.write(
            "Auto encoder -> Performing auto encoder initialization test ..."
        )
        sys.stdout.flush()
        ...
        for loss in [CFct.SquaredError, CFct.CrossEntropyError]:
            for act_in in [
                ...
                for act_out in [
                    ...
                    if loss != CFct.CrossEntropyError or (
                        loss == CFct.CrossEntropyError and act_in == AFct.Sigmoid
                    ):
                        ae = MODEL.AutoEncoder(
                            number_visibles=N,
                            number_hiddens=M,
    ...
    def test_model_gradients(self):
        ...
        sys.stdout.write(
            "Auto encoder -> Performing finite differences check of all possible Auto encoder models ..."
        )
        sys.stdout.flush()
    ...
    def test_ae_gradients(self):
        ...
        sys.stdout.write(
            "Auto encoder -> Performing finite differences check of all possible normal auto encoder ..."
        )
        sys.stdout.flush()
        data = generate_bars_and_stripes_complete(5)[0:2]
        data_next = generate_bars_and_stripes_complete(5)[2:4]
    ...
    def test_cae_gradients(self):
        """Checks all possible combinations by finite differences."""
        sys.stdout.write(
            "Auto encoder -> Performing finite differences check of all possible contractive auto encoder models ..."
        )
        sys.stdout.flush()
        data = generate_bars_and_stripes_complete(5)[0:2]
        data_next = generate_bars_and_stripes_complete(5)[2:4]
    ...
    def test_sae_gradients(self):
        """Checks all possible combinations  by finite differences."""
        sys.stdout.write(
            "Auto encoder -> Performing finite differences check of all possible sparse auto encoder models ..."
        )
        sys.stdout.flush()
        data = generate_bars_and_stripes_complete(5)[0:2]
        data_next = generate_bars_and_stripes_complete(5)[2:4]
    ...
    def test_slae_gradients(self):
        """Checks all possible combinations by finite differences."""
        sys.stdout.write(
            "Auto encoder -> Performing finite differences check of all possible slowness auto encoder models ..."
        )
        sys.stdout.flush()
        data = generate_bars_and_stripes_complete(5)[0:2]
        data_next = generate_bars_and_stripes_complete(5)[2:4]
    ...
    def test_allpenelties_gradients(self):
        """Checks all possible combinations (act fct., penalties, etc.) by finite differences."""
        sys.stdout.write(
            "Auto encoder -> Performing finite differences check of all possible contractive+sparse+slow auto encoder models ..."
        )
        sys.stdout.flush()
        data = generate_bars_and_stripes_complete(5)[0:2]
        data_next = generate_bars_and_stripes_complete(5)[2:4]
