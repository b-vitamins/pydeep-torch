...
class TestActivationFunction(unittest.TestCase):
    ...
    def test_HyperbolicTangent(self):
        ...
        assert numx.all(
            numx.abs(-0.999329299739 - HyperbolicTangent().f(-4.0)) < epsilon
        )

        assert numx.all(
            numx.abs(-0.972955074528 - HyperbolicTangent().g(-0.75)) < epsilon
        )
        ...
        assert numx.all(
            numx.abs(0.00134095068303 - HyperbolicTangent().df(4.0)) < epsilon
        )
        ...
        assert numx.all(
            numx.abs(-0.00268010261411 - HyperbolicTangent().ddf(4.0)) < epsilon
        )
        assert numx.all(numx.abs(-0.0 - HyperbolicTangent().ddf(0.0)) < epsilon)
        assert numx.all(
            numx.abs(0.00268010261411 - HyperbolicTangent().ddf(-4.0)) < epsilon
        )

        assert numx.all(
            numx.abs(2.28571428571 - HyperbolicTangent().dg(-0.75)) < epsilon
        )
    ...
    def test_SoftMax(self):
        ...
        assert numx.all(
            numx.abs(
                numx.array([[0.28001309, 0.34200877, 0.37797814]])
                - SoftMax().f(numx.array([[0.2, 0.4, 0.5]]))
            )
            < epsilon
        )
        assert numx.all(
            numx.abs(
                numx.array([[0.33333333, 0.33333333, 0.33333333]])
                - SoftMax().f(numx.array([[0.5, 0.5, 0.5]]))
            )
            < epsilon
        )
        assert numx.all(
            numx.abs(
                numx.array([[0.57244661, 0.21484557, 0.21270782]])
                - SoftMax().f(numx.array([[0.99, 0.01, 0.0]]))
            )
            < epsilon
        )
        ...
        assert numx.all(
            numx.abs(
                numx.array([[[0.16, -0.08], [-0.08, 0.24]]])
                - SoftMax().df(numx.array([[0.2, 0.4]]))
            )
            < epsilon
        )
        assert numx.all(
            numx.abs(
                numx.array([[[0.25, -0.25], [-0.25, 0.25]]])
                - SoftMax().df(numx.array([[0.5, 0.5]]))
            )
            < epsilon
        )
        assert numx.all(
            numx.abs(
                numx.array([[[0.0099, 0.0], [0.0, 0.0]]])
                - SoftMax().df(numx.array([[0.99, 0.0]]))
            )
            < epsilon
        )
    ...
    def test_RadialBasis(self):
        ...
        assert numx.all(
            numx.abs(0.0183156388887 - RadialBasis(0.0, 1.0).f(2.0)) < epsilon
        )
        ...
        assert numx.all(
            numx.abs(0.513417119033 - RadialBasis(1.0, 1.5).f(2.0)) < epsilon
        )
        assert numx.all(
            numx.abs(0.513417119033 - RadialBasis(1.0, 1.5).f(0.0)) < epsilon
        )
        assert numx.all(
            numx.abs(0.00247875217667 - RadialBasis(1.0, 1.5).f(-2.0)) < epsilon
        )

        assert numx.all(
            numx.abs(-0.0732625555549 - RadialBasis(0.0, 1.0).df(2.0)) < epsilon
        )
        ...
        assert numx.all(
            numx.abs(-0.68455615871 - RadialBasis(1.0, 1.5).df(2.0)) < epsilon
        )
        assert numx.all(
            numx.abs(0.68455615871 - RadialBasis(1.0, 1.5).df(0.0)) < epsilon
        )
        assert numx.all(
            numx.abs(0.00991500870667 - RadialBasis(1.0, 1.5).df(-2.0)) < epsilon
        )
        print(" successfully passed!")
        sys.stdout.flush()
