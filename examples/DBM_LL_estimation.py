...
for epoch in range(0, epochs + 1):
    ...
    if epoch % 10000 == 0:
        print("Epoche: ", epoch)
        logZ, logZ_up, logZ_down = ESTIMATOR.partition_function_AIS(
...
# Show weights
VIS.imshow_matrix(
    VIS.tile_matrix_rows(dbm.W1, v11, v12, v21, v22, border_size=1, normalized=False),
    "Weights 1",
)
VIS.imshow_matrix(
    VIS.tile_matrix_rows(
        numx.dot(dbm.W1, dbm.W2), v11, v12, v31, v32, border_size=1, normalized=False
    ),
    "Weights 2",
)
