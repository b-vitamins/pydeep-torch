...
vis.plot_2d_weights(
    numxext.resize_norms(zca.project(mixing_matrix.T).T, norm=scale_factor, axis=0)
)
vis.axis("equal")
vis.axis([-4, 4, -4, 4])
...
vis.plot_2d_data(whitened_data)
vis.plot_2d_weights(
    numxext.resize_norms(ica.projection_matrix, norm=scale_factor, axis=0)
)
vis.axis("equal")
vis.axis([-4, 4, -4, 4])
...
vis.plot_2d_data(data)
vis.plot_2d_weights(
    numxext.resize_norms(
        zca.unproject(ica.projection_matrix.T).T, norm=scale_factor, axis=0
    )
)
vis.axis("equal")
vis.axis([-4, 4, -4, 4])
