...
logZ = estimator.partition_function_factorize_h(
    rbm, batchsize_exponent=h1, status=False
)
print(
    "True Partition: {} (LL train: {}, LL test: {})".format(
        logZ,
...
print(
    "AIS Partition: {} (LL train: {}, LL test: {})".format(
        logZ_approx_AIS,
...
print(
    "reverse AIS Partition: {} (LL train: {}, LL test: {})".format(
        logZ_approx_rAIS,
